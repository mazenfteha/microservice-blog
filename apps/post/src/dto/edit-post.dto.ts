...
export class EditPostDto {
    @IsString()
    @IsOptional()
    @ApiProperty({ example: 'A Day in the Life updated', description: 'The title of the post' })
    title?: string;
    ...
    @IsString()
    @IsOptional()
    @ApiProperty({ example: 'published', description: 'The status of the post', required: false })
    status? :string;
